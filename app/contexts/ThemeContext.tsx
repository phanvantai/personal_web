...
export const colorOptions = {
    purple: '#8a85e6', // Changed from #6c63ff to a softer purple
    blue: '#6b9aef',   // Changed from #2563eb to a softer blue
    teal: '#5bbab3',   // Changed from #0d9488 to a softer teal
    rose: '#f07a98'    // Changed from #f43f5e to a softer rose
}
